...
CREATE POLICY "mt_configuracoes_select_all" ON public.mt_configuracoes
FOR SELECT USING (true);

-- Permite gravação/alteração APENAS para administradores
CREATE POLICY "mt_configuracoes_admin_all" ON public.mt_configuracoes
...
CREATE POLICY "mt_financeiro_select_authenticated" ON public.mt_financeiro
FOR SELECT TO authenticated USING (true);

-- Permite gravação/alteração APENAS para administradores
CREATE POLICY "mt_financeiro_admin_all" ON public.mt_financeiro
FOR ALL TO authenticated
USING (app_private.is_fm_admin())
WITH CHECK (app_private.is_fm_admin());
...
CREATE POLICY "mt_times_select_all" ON public.mt_times
FOR SELECT USING (true);

-- Permite acesso total para qualquer jogador autenticado (e admins)
CREATE POLICY "mt_times_all_authenticated" ON public.mt_times
FOR ALL TO authenticated
USING (true)
WITH CHECK (true);
...
CREATE POLICY "mt_partidas_select_all" ON public.mt_partidas
FOR SELECT USING (true);

-- Permite acesso total para qualquer jogador autenticado (e admins)
CREATE POLICY "mt_partidas_all_authenticated" ON public.mt_partidas
FOR ALL TO authenticated
USING (true)
WITH CHECK (true);
...
CREATE POLICY "mt_pagamento_jogadores_select_all" ON public.mt_pagamento_jogadores
FOR SELECT USING (true);

-- Permite acesso total para qualquer jogador autenticado (e admins)
CREATE POLICY "mt_pagamento_jogadores_all_authenticated" ON public.mt_pagamento_jogadores
FOR ALL TO authenticated
USING (true)
WITH CHECK (true);
